 ...
 * @author Tim Slifer
 */
public class IsNotSameHourOfDay implements Expectation<LocalTime> {
    
    private LocalTime localTime;
    
    public IsNotSameHourOfDay(LocalTime localTime) {
        this.localTime = localTime;
    }
    
    @Override
    public Matcher<LocalTime> matcher() {
        return not(LocalTimeMatchers.sameHourOfDay(localTime));
    }
