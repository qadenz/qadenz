 ...
 * @author Tim Slifer
 */
public class TemporalIsNotWithin<T, E> implements TemporalExpectation<T> {
    ...
    public TemporalIsNotWithin(Temporal temporal, long period, ChronoUnit chronoUnit, TemporalConverter<T, E> converter,
