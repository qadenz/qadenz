 ...
 * @author Tim Slifer
 */
public class TemporalIsNotSameMinute<T> implements TemporalExpectation<T> {
    ...
    public TemporalIsNotSameMinute(Temporal temporal, TemporalConverter<T, Minute> converter,
