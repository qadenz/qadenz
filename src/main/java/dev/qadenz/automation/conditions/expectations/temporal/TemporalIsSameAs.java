...
/**
 * An expectation for the text of an element, represented as a Temporal, to be the same as the given Temporal.
 *
 * @author Tim Slifer
 */
public class TemporalIsSameAs<T, E> implements TemporalExpectation<T> {
    ...
    public Matcher<T> matcher() {
        return new IsSameDay<>(converter, provider);
    }
    
    @Override
    public String description() {
        return "is the same as [" + dateTimeFormatter.format(temporal) + "]";
    }
