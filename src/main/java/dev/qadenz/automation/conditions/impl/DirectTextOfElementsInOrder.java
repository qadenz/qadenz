 ...
 * @author Tim Slifer
 */
public class DirectTextOfElementsInOrder implements Condition {
    ...
    public DirectTextOfElementsInOrder(Locator locator, ListExpectation expectation) {
    ...
    public String toString() {
        return "Direct text of each instance of element [" + locator.getName() + "] " + expectation + ".";
    }
}
