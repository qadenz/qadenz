...
import dev.qadenz.automation.expectations.bool.IsFalse;
import dev.qadenz.automation.expectations.bool.IsTrue;
import dev.qadenz.automation.expectations.numeric.integer.IntegerIsEqualTo;
import dev.qadenz.automation.expectations.numeric.integer.IntegerIsGreaterThan;
import dev.qadenz.automation.expectations.numeric.integer.IntegerIsGreaterThanOrEqualTo;
import dev.qadenz.automation.expectations.numeric.integer.IntegerIsLessThan;
import dev.qadenz.automation.expectations.numeric.integer.IntegerIsLessThanOrEqualTo;
import dev.qadenz.automation.expectations.numeric.integer.IntegerIsNotEqualTo;
import dev.qadenz.automation.expectations.string.Contains;
import dev.qadenz.automation.expectations.string.ContainsIgnoreCase;
import dev.qadenz.automation.expectations.string.DoesNotContain;
import dev.qadenz.automation.expectations.string.DoesNotEndWith;
import dev.qadenz.automation.expectations.string.DoesNotStartWith;
import dev.qadenz.automation.expectations.string.EndsWith;
import dev.qadenz.automation.expectations.string.EqualsIgnoreCase;
import dev.qadenz.automation.expectations.string.IsEmptyOrNull;
import dev.qadenz.automation.expectations.string.IsEqualTo;
import dev.qadenz.automation.expectations.string.IsEqualToOneOf;
import dev.qadenz.automation.expectations.string.IsNotEmptyOrNull;
import dev.qadenz.automation.expectations.string.IsNotEqualTo;
import dev.qadenz.automation.expectations.string.StartsWith;
import dev.qadenz.automation.expectations.temporal.localdate.LocalDateIsAfter;
import dev.qadenz.automation.expectations.temporal.localdate.LocalDateIsBefore;
import dev.qadenz.automation.expectations.temporal.localdate.LocalDateIsDayOfWeek;
import dev.qadenz.automation.expectations.temporal.localdate.LocalDateIsNotDayOfWeek;
import dev.qadenz.automation.expectations.temporal.localdate.LocalDateIsNotSameAs;
import dev.qadenz.automation.expectations.temporal.localdate.LocalDateIsNotWithin;
import dev.qadenz.automation.expectations.temporal.localdate.LocalDateIsSameAs;
import dev.qadenz.automation.expectations.temporal.localdate.LocalDateIsSameAsOrAfter;
import dev.qadenz.automation.expectations.temporal.localdate.LocalDateIsSameAsOrBefore;
import dev.qadenz.automation.expectations.temporal.localdate.LocalDateIsWithin;
import dev.qadenz.automation.expectations.temporal.localdatetime.LocalDateTimeIsAfter;
import dev.qadenz.automation.expectations.temporal.localdatetime.LocalDateTimeIsBefore;
import dev.qadenz.automation.expectations.temporal.localdatetime.LocalDateTimeIsDayOfWeek;
import dev.qadenz.automation.expectations.temporal.localdatetime.LocalDateTimeIsNotDayOfWeek;
import dev.qadenz.automation.expectations.temporal.localdatetime.LocalDateTimeIsNotSameAs;
import dev.qadenz.automation.expectations.temporal.localdatetime.LocalDateTimeIsNotWithin;
import dev.qadenz.automation.expectations.temporal.localdatetime.LocalDateTimeIsSameAs;
import dev.qadenz.automation.expectations.temporal.localdatetime.LocalDateTimeIsSameAsOrAfter;
import dev.qadenz.automation.expectations.temporal.localdatetime.LocalDateTimeIsSameAsOrBefore;
import dev.qadenz.automation.expectations.temporal.localdatetime.LocalDateTimeIsWithin;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsAfter;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsBefore;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsNotSameHourOfDay;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsNotSameMinuteOfHour;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsNotSameSecondOfMinute;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsNotWithin;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsSameAsOrAfter;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsSameAsOrBefore;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsSameHourOfDay;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsSameMinuteOfHour;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsSameSecondOfMinute;
import dev.qadenz.automation.expectations.temporal.localtime.LocalTimeIsWithin;
