 ...
 * <p>
 * Note that it is expected that ExpectedConditions are idempotent. They will be called in a loop by the {@link
 * WebElementWait} and any modification of the state of the application under test may have unexpected side-effects.
 *
