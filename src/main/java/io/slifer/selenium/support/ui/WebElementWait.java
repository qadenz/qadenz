...
/**
 * A specialization of {@link FluentWait} that uses WebElement instances.
 */
public class WebElementWait extends FluentWait<WebElement> {
     ...
     *
     * @param element The WebElement instance to pass to the expected conditions
     * @param timeOutInSeconds The timeout in seconds when an expectation is called
     *
     * @see WebDriverWait#ignoring(Class)
     */
    public WebElementWait(WebElement element, long timeOutInSeconds) {
        this(element, Clock.systemDefaultZone(), Sleeper.SYSTEM_SLEEPER, timeOutInSeconds, DEFAULT_SLEEP_TIMEOUT);
    }
    ...
    public WebElementWait(WebElement element, long timeOutInSeconds, long sleepInMillis) {
        this(element, Clock.systemDefaultZone(), Sleeper.SYSTEM_SLEEPER, timeOutInSeconds, sleepInMillis);
    }
     ...
     */
    public WebElementWait(WebElement element, Clock clock, Sleeper sleeper, long timeOutInSeconds, long sleepTimeOut) {
    ...
    //     WebDriver exceptionDriver = element;
